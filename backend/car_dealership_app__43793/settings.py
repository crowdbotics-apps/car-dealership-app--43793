"""
Django settings for car_dealership_app__43793 project.
...
ROOT_URLCONF = 'car_dealership_app__43793.urls'
...
WSGI_APPLICATION = 'car_dealership_app__43793.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "car_dealership_app__43793 API",
    "DESCRIPTION": "API documentation for car_dealership_app__43793 App",
    "VERSION": "v1",
}
